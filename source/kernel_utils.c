  ...
  *sceProcCap = 0xffffffffffffffff;
  ...
  if (fw_version == 0x405) {
    ...
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K405_SET_TIME];
    ...
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K455_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K455_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K455_SET_TIME];
    ...
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K474_SET_TIME];
    ...
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K501_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K501_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K501_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else if (fw_version == 0x503) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K503_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    ...
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K505_SET_TIME];
    ...
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K672_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K672_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K672_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else {
    return -1;
  }
