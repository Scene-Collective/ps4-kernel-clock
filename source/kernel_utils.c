...
int kpayload_jailbreak(struct thread *td, struct kpayload_jailbreak_args *args) {
  ...
  *sceProcCap = 0xffffffffffffffff;
  ...
  if (fw_version == 0x350) {
    ...
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K350_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    // *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K350_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K350_SET_TIME];
  } else if (fw_version == 0x355) {
    // Needs Verified
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K355_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    // *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K355_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K355_SET_TIME];
  } else if (fw_version == 0x370) {
    // Needs Verified
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K370_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    // *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K370_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K370_SET_TIME];
  } else if (fw_version == 0x400) {
    // Needs Verified
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K400_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    // *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K400_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K400_SET_TIME];
  } else if (fw_version == 0x401) {
    // Needs Verified
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K401_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    // *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K401_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K401_SET_TIME];
  } else if (fw_version == 0x405) {
    // Needs Verified
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K405_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    // *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K405_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K405_SET_TIME];
  } else if (fw_version == 0x406) {
    // Needs Verified
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K406_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    // *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K406_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K406_SET_TIME];
  } else if (fw_version == 0x407) {
    // Needs Verified
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K407_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    // *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K407_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K407_SET_TIME];
  } else if (fw_version == 0x450 || fw_version == 0x455) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K450_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K450_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K450_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else if (fw_version == 0x470) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K470_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K470_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K470_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else if (fw_version == 0x471 || fw_version == 0x472 || fw_version == 0x473) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K471_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K471_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K471_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else if (fw_version == 0x474) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K474_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K474_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K474_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else if (fw_version == 0x500 || fw_version == 0x501) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K500_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K500_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K500_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else if (fw_version == 0x503) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K503_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K503_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K503_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else if (fw_version == 0x505 || fw_version == 0x507) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K505_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K505_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K505_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else if (fw_version == 0x550) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K550_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K550_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K550_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else if (fw_version == 0x553) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K553_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K553_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K553_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else if (fw_version == 0x555 || fw_version == 0x556) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K555_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K555_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K555_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else if (fw_version == 0x600 || fw_version == 0x602) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K600_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K600_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K600_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else if (fw_version == 0x620) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K620_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K620_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K620_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else if (fw_version == 0x650 || fw_version == 0x651) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K650_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K650_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K650_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else if (fw_version == 0x670 || fw_version == 0x671 || fw_version == 0x672) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K670_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K670_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K670_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else if (fw_version == 0x700 || fw_version == 0x701 || fw_version == 0x702) {
    kernel_base = &((uint8_t *)__readmsr(0xC0000082))[-K700_XFAST_SYSCALL];
    kernel_ptr = (uint8_t *)kernel_base;
    *(void **)(&sceSblSrtcClearTimeDifference) = &kernel_ptr[K700_CLEAR_TIME_DIFFERENCE];
    *(void **)(&sceSblSrtcSetTime) = &kernel_ptr[K700_SET_TIME];
    sceSblSrtcClearTimeDifference(15);
  } else {
    return -1;
  }
